...
public:
	...
	void giro90Izq(){orient = static_cast<Orientacion> ((orient+6)%8);}
	void giro90Dch(){orient = static_cast<Orientacion> ((orient+2)%8);}
    ...
    string stringOrientacion (Orientacion x);
	string toString();
